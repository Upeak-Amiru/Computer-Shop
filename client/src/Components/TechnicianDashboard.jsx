    ...
    <div className="container-fluid" > 
      ...
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 custom-bg  ">   
        ...
        > 
          ...
          <li className="w-100"> 
            <Link 
            to="/TechnicianDashboard/technicianrepairs" 
            className="d-flex nav-link text-white px-0 align-middle" 
            > 
            <i className="fs-4 bi-people ms-2"></i> 
            <span className="ms-2 d-none d-sm-inline">Repairs</span> 
            </Link> 
          </li> 
          <li className="w-100"> 
            <Link 
            to="/TechnicianDashboard/technicianrepairbill" 
            className="d-flex nav-link text-white px-0 align-middle" 
            > 
            <i className="fs-4 bi-columns ms-2"></i> 
            <span className="ms-2 d-none d-sm-inline">Repair Bill</span> 
            </Link> 
          </li>  
          <li className="w-100"> 
            <Link 
            to="/TechnicianDashboard/technicianreport" 
            className="d-flex nav-link text-white px-0 align-middle" 
            > 
            <i className="fs-4 bi-columns ms-2"></i> 
