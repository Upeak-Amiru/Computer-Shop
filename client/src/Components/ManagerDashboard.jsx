    ...
    <div className="container-fluid" > 
      ...
      <div className="col-auto col-md-3 col-xl-2 px-sm-2 px-0 custom-bg  ">   
        ...
        > 
          ...
          <li className="w-100"> 
            <Link 
            to="/managerdashboard/otherroles" 
            className="d-flex nav-link text-white px-0 align-middle" 
            > 
            <i className="fs-4 bi-columns ms-2"></i> 
            <span className="ms-2 d-none d-sm-inline">Other Roles</span> 
            </Link> 
          </li> 
          <li className="w-100"> 
            <Link 
            to="/managerdashboard/manageaccounts" 
            className="d-flex nav-link text-white px-0 align-middle" 
            > 
            <i className="fs-4 bi-columns ms-2"></i> 
            <span className="ms-2 d-none d-sm-inline">Manage Accounts</span> 
            </Link> 
          </li> 
          <li className="w-100"> 
            <Link 
